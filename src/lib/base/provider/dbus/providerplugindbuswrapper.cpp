...
bool ProviderPluginDBusWrapper::load(const QString &plugin)
{
    ...
    connect(d->proxy,
     SIGNAL(journeysAndWaitingTimesFromStationRequested(QString,PublicTransportation::Station,int)),
            d->provider,
       SLOT(retrieveJourneysAndWaitingTimesFromStation(QString,PublicTransportation::Station,int)));
    connect(d->provider,
            SIGNAL(journeysAndWaitingTimesFromStationRetrieved(QString,QList<PublicTransportation::InfoJourneyWaitingTime>)),
            d->proxy,
            SLOT(registerJourneysAndWaitingTimesFromStation(QString,QList<PublicTransportation::InfoJourneyWaitingTime>)));
    ...
    connect(d->proxy, SIGNAL(stationsFromJourneyRequested(QString,PublicTransportation::Company,
                                                          ...
                                                          PublicTransportation::Journey,
                                                          PublicTransportation::Station)),
            d->provider, SLOT(retrieveStationsFromJourney(QString,PublicTransportation::Company,
                                                          PublicTransportation::Line,
                                                          PublicTransportation::Journey,
                                                          PublicTransportation::Station)));
    connect(d->provider,
            SIGNAL(stationsFromJourneyRetrieved(QString,QList<PublicTransportation::Station>)),
            d->proxy,
            SLOT(registerStationsFromJourney(QString,QList<PublicTransportation::Station>)));
