...
#ifndef PUBLICTRANSPORTATION_PROVIDER_REITTIOPAS_H
#define PUBLICTRANSPORTATION_PROVIDER_REITTIOPAS_H
...
class HslPrivate;
class Hsl : public ProviderPluginObject
{
    Q_OBJECT
    Q_INTERFACES(PublicTransportation::ProviderPluginInterface)
public:
    explicit Hsl(QObject *parent = 0);
...
protected:
    QScopedPointer<HslPrivate> d_ptr;
private:
    Q_DECLARE_PRIVATE(Hsl)
...
#endif // PUBLICTRANSPORTATION_PROVIDER_REITTIOPAS_H
